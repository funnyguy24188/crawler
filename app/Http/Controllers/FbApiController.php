...
class FbApiController extends Controller
{
    ...
    private $app_id = '508842445974753';
    private $app_secrect = '6bbbb49f3c211cc233fe69dcb8623951';
    ...
    public function fbLogin()
    {
        ...
        $loginUrl = $helper->getLoginUrl('http://http://crawler.ladynashop.com/fb_callback', $permissions);

        echo '<a href="' . htmlspecialchars($loginUrl) . '">Log in with Facebook!</a>';
    }

    public function fbCallbackToken()
    {
        $fb = new Facebook([
            'app_id' => $this->app_id, // Replace {app-id} with your app id
            'app_secret' => $this->app_secrect,
